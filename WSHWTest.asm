...
IOTestLoop:
	mov bp, dx
	add bp, dx
;	mov bx, [ds:ioRegMasksASWAN,bp]
;	mov bx, [ds:ioRegMasksSPHINXMono,bp]
	mov bx, [ds:ioRegMasksSPHINX2Mono,bp]
	cmp bx, 0xffff
	jz skipIOTest
...
ioRegMasksASWAN:
	dw 0x003f, 0x0007, 0xffff, 0x00ff, 0x001f, 0x007f, 0x00ff, 0x0077
	dw 0x00ff, 0x00ff, 0x00ff, 0x00ff, 0x00ff, 0x00ff, 0x00ff, 0x00ff
	dw 0x00ff, 0x00ff, 0x00ff, 0x00ff, 0x00f1, 0x003f, 0x00ff, 0x00ff
	dw 0xffff, 0x9090, 0xffff, 0x0000, 0x00ff, 0x00ff, 0x00ff, 0x00ff
	dw 0x0077, 0x0077, 0x0077, 0x0077, 0x0077, 0x0077, 0x0077, 0x0077
	dw 0x0070, 0x0077, 0x0070, 0x0077, 0x0070, 0x0077, 0x0070, 0x0077
	dw 0x0077, 0x0077, 0x0077, 0x0077, 0x0077, 0x0077, 0x0077, 0x0077
	dw 0x0070, 0x0077, 0x0070, 0x0077, 0x0070, 0x0077, 0x0070, 0x0077
	...
	dw 0x9090, 0x9090, 0x9090, 0x9090, 0x9090, 0x9090, 0x9090, 0x9090
	dw 0x9090, 0x9090, 0x9090, 0x9090, 0x9090, 0x9090, 0x9090, 0x9090
	dw 0x00ff, 0x0007, 0x00ff, 0x0007, 0x00ff, 0x0007, 0x00ff, 0x0007
	dw 0x00ff, 0x00ff, 0x00ff, 0x00ff, 0x00ff, 0x001f, 0x0017, 0x00ff
	dw 0x00ef, 0xffff, 0xffff, 0xffff, 0x000f, 0x00ff, 0xffff, 0xffff
	dw 0xffff, 0xffff, 0xffff, 0xffff, 0xffff, 0xffff, 0x9090, 0x9090
	dw 0xffff, 0x9090, 0x000f, 0x000f, 0x00ff, 0x00ff, 0x00ff, 0x00ff
	dw 0xffff, 0xffff, 0xffff, 0xffff, 0x9090, 0x9090, 0x9090, 0x9090
ioRegMasksSPHINXMono:
	dw 0x003f, 0x0007, 0xffff, 0x00ff, 0x001f, 0x007f, 0x00ff, 0x0077
	dw 0x00ff, 0x00ff, 0x00ff, 0x00ff, 0x00ff, 0x00ff, 0x00ff, 0x00ff
	dw 0x00ff, 0x00ff, 0x00ff, 0x00ff, 0x00f1, 0x003f, 0x00ff, 0x00ff
	dw 0xffff, 0x0000, 0xffff, 0x0000, 0x00ff, 0x00ff, 0x00ff, 0x00ff
	dw 0x0077, 0x0077, 0x0077, 0x0077, 0x0077, 0x0077, 0x0077, 0x0077
	dw 0x0070, 0x0077, 0x0070, 0x0077, 0x0070, 0x0077, 0x0070, 0x0077
	dw 0x0077, 0x0077, 0x0077, 0x0077, 0x0077, 0x0077, 0x0077, 0x0077
	dw 0x0070, 0x0077, 0x0070, 0x0077, 0x0070, 0x0077, 0x0070, 0x0077
	...
	dw 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000
	dw 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000
	dw 0xffff, 0x0000, 0x0001, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000
	dw 0x0000, 0x0000, 0x00ff, 0x006f, 0x0000, 0x0000, 0x0000, 0x0000
	dw 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000
	dw 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000
	dw 0x00ff, 0x0007, 0x00ff, 0x0007, 0x00ff, 0x0007, 0x00ff, 0x0007
	dw 0x00ff, 0x00ff, 0x00ff, 0x00ff, 0x00ff, 0x001f, 0x0017, 0x00ff
	dw 0x00ef, 0xffff, 0xffff, 0xffff, 0x000f, 0x00ff, 0xffff, 0xffff
	dw 0xffff, 0xffff, 0xffff, 0xffff, 0xffff, 0xffff, 0x0003, 0x0000
	dw 0xffff, 0x0000, 0x000f, 0x000f, 0x00ff, 0x00ff, 0x00ff, 0x00ff
...
ioRegMasksSPHINX:
	...
	dw 0x9090, 0x9090, 0x9090, 0x9090, 0x9090, 0x9090, 0x9090, 0x9090
	dw 0x9090, 0x9090, 0x9090, 0x9090, 0x9090, 0x9090, 0x9090, 0x9090
	dw 0xffff, 0x9090, 0x9090, 0x9090, 0x9090, 0x9090, 0x9090, 0x9090
	dw 0x9090, 0x9090, 0x9090, 0x9090, 0x9090, 0x9090, 0x9090, 0x9090
	dw 0x9090, 0x9090, 0x9090, 0x9090, 0x9090, 0x9090, 0x9090, 0x9090
	dw 0x9090, 0x9090, 0x9090, 0x9090, 0x9090, 0x9090, 0x9090, 0x9090
	dw 0x00ff, 0x0007, 0x00ff, 0x0007, 0x00ff, 0x0007, 0x00ff, 0x0007
	...
	dw 0xffff, 0xffff, 0xffff, 0xffff, 0xffff, 0xffff, 0x9090, 0x9090
	dw 0xffff, 0x9090, 0x000f, 0x000f, 0x00ff, 0x00ff, 0x00ff, 0x00ff
	dw 0xffff, 0xffff, 0xffff, 0xffff, 0xffff, 0x9090, 0x9090, 0x9090
ioRegMasksSPHINX2:
	dw 0x003f, 0x0007, 0xffff, 0x00ff, 0x001f, 0x007f, 0x00ff, 0x0077
	dw 0x00ff, 0x00ff, 0x00ff, 0x00ff, 0x00ff, 0x00ff, 0x00ff, 0x00ff
	dw 0x00ff, 0x00ff, 0x00ff, 0x00ff, 0x00f1, 0x003f, 0x00ff, 0x00ff
...
ioRegMasksSPHINX2Mono:
	dw 0x003f, 0x0007, 0xffff, 0x00ff, 0x001f, 0x007f, 0x00ff, 0x0077
	dw 0x00ff, 0x00ff, 0x00ff, 0x00ff, 0x00ff, 0x00ff, 0x00ff, 0x00ff
	dw 0x00ff, 0x00ff, 0x00ff, 0x00ff, 0x0001, 0x003f, 0x00ff, 0x0000
	dw 0xffff, 0x0000, 0xffff, 0x0000, 0x00ff, 0x00ff, 0x00ff, 0x00ff
	dw 0x0077, 0x0077, 0x0077, 0x0077, 0x0077, 0x0077, 0x0077, 0x0077
	dw 0x0070, 0x0077, 0x0070, 0x0077, 0x0070, 0x0077, 0x0070, 0x0077
	dw 0x0077, 0x0077, 0x0077, 0x0077, 0x0077, 0x0077, 0x0077, 0x0077
	...
	dw 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000
	dw 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000
	dw 0xffff, 0x0000, 0x8081, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000
	dw 0x0000, 0x0000, 0x00ff, 0x006f, 0x0000, 0x0000, 0x0000, 0x0000
...
headLineStr: db " WonderSwan HW Test 20250408", 10, 0
